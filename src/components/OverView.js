    ...
    <div>
      <div className='flex-row items-center pl-5 justify-center pt-3 ' id='Overview'>
        ...
        <div className={Styles.sectionText}>
            I'm a skilled web developer with experience in javascript and expertise in frameworks like React, Node.js .I'm a quick learner and collaborate, scalable and user-friendly solutions that solves realworld problems . Let's work together to bring your ideas to life!
        </div>
      ...
      <div className='flex flex-wrap justify-center'>
        {services.map((service) => (
            <div >
                <Tilt
                    key={service.icon}
 className="parallax-effect-glance-scale"
 perspective={500}
 glarecolor="fed7aa"
 glareEnable={true}
